...
#include <cmath>
#include "diana_foot_step_generator/robotis_foot_step_generator.h"
...
{
  num_of_step_             = 2*2 + 2;
  fb_step_length_m_        = 0.05;
  rl_step_length_m_        = 0.03;
...
diana_online_walking_module_msgs::PoseXYZRPY FootStepGenerator::getPosefromTransformMatrix(const Eigen::MatrixXd &matTransform)
{
  diana_online_walking_module_msgs::PoseXYZRPY pose;
...
void FootStepGenerator::getStepData(diana_online_walking_module_msgs::AddStepDataArray::Request::_step_data_array_type* step_data_array, const diana_online_walking_module_msgs::StepData& ref_step_data, int desired_step_type)
{
...
//void FootStepGenerator::getStepDataFromStepData2DArray(diana_online_walking_module_msgs::AddStepDataArray::Request::_step_data_array_type* step_data_array,
...
//  step_data_array->clear();
//
//  diana_online_walking_module_msgs::StepData stp_data;
//
//  stp_data = ref_step_data;
//  stp_data.time_data.abs_step_time += start_end_time_sec_;
//  stp_data.time_data.dsp_ratio = dsp_ratio_;
//  stp_data.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_STARTING;
...
//
//  stp_data.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::STANDING;
...
//    stp_data.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING;
//
//    if(request_step_2d->footsteps_2d[stp_idx].moving_foot == thormang3_foot_step_generator::Step2D::LEFT_FOOT_SWING)
//    {
//      stp_data.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING;
...
//    {
//      stp_data.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::RIGHT_FOOT_SWING;
//      stp_data.position_data.body_z_swap = body_z_swap_m_;
//      stp_data.position_data.foot_z_swap = foot_z_swap_m_;
...
//  stp_data.time_data.abs_step_time += start_end_time_sec_;
//  stp_data.time_data.dsp_ratio = dsp_ratio_;
//  stp_data.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_ENDING;
//  stp_data.time_data.start_time_delay_ratio_x     = 0.0;
//  stp_data.time_data.start_time_delay_ratio_y     = 0.0;
//  stp_data.time_data.start_time_delay_ratio_z     = 0.0;
//  stp_data.time_data.start_time_delay_ratio_roll  = 0.0;
...
{
  int direction = 0;
  diana_online_walking_module_msgs::StepData stp_data[2];

  diana_online_walking_module_msgs::PoseXYZRPY poseGtoRF, poseGtoLF;
  diana_online_walking_module_msgs::PoseXYZRPY poseLtoRF, poseLtoLF;
  ...
  if(stp_data[0].time_data.walking_state != diana_online_walking_module_msgs::StepTimeData::IN_WALKING)
  {
  ...
  else
  {
    ...
    {
      stp_data[0].time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING;
...
//      }
      ...
      else if(desired_step_type == LEFTWARD_WALKING || desired_step_type == LEFT_ROTATING_WALKING)
      {
        if(stp_data[0].position_data.moving_foot == diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING)
        {
          ...
          stp_data[1].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::RIGHT_FOOT_SWING;
      ...
      {
        if(stp_data[0].position_data.moving_foot == diana_online_walking_module_msgs::StepPositionData::RIGHT_FOOT_SWING)
        {
          stp_data[1].time_data.abs_step_time += step_time_sec_;
          stp_data[1].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING;
          step_data_array_.push_back(stp_data[1]);
        }
      }
      else
...
void FootStepGenerator::calcFBStep(const diana_online_walking_module_msgs::StepData& ref_step_data, int direction)
{
  diana_online_walking_module_msgs::StepData stp_data[num_of_step_];
  stp_data[0] = ref_step_data;

  if(ref_step_data.time_data.walking_state == diana_online_walking_module_msgs::StepTimeData::IN_WALKING)
  {
    stp_data[0].time_data.abs_step_time += step_time_sec_;
    ...
    for(int stp_idx = 1; stp_idx < num_of_step_-2; stp_idx++)
    {
      ...
      {
        stp_data[stp_idx].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING;
    ...
    if(stp_data[num_of_step_-2].position_data.moving_foot == diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING)
    {
      stp_data[num_of_step_-2].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::RIGHT_FOOT_SWING;
      stp_data[num_of_step_-2].position_data.right_foot_pose.x = stp_data[num_of_step_-2].position_data.left_foot_pose.x;
    }
    else
    {
      stp_data[num_of_step_-2].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING;
    ...
    stp_data[num_of_step_-1].time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_ENDING;
    stp_data[num_of_step_-1].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::STANDING;
    stp_data[num_of_step_-1].position_data.body_z_swap = 0;
  }
  else
  {
    stp_data[0].time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_STARTING;
    stp_data[0].time_data.abs_step_time += start_end_time_sec_;
    stp_data[0].position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::STANDING;
    stp_data[0].position_data.body_z_swap = 0;

    for(int stp_idx = 1; stp_idx < num_of_step_-2; stp_idx++)
    {
      stp_data[stp_idx] = stp_data[stp_idx-1];
      stp_data[stp_idx].time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING;
      stp_data[stp_idx].time_data.abs_step_time += step_time_sec_;
...
void FootStepGenerator::calcRLStep(const diana_online_walking_module_msgs::StepData& ref_step_data, int direction)
{
  diana_online_walking_module_msgs::StepData stp_data[num_of_step_];
  stp_data[0] = ref_step_data;
  ...
  else
  {
    ...
    stp_data[1] = stp_data[0];
    stp_data[1].time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING;
    stp_data[1].time_data.abs_step_time += step_time_sec_;
...
void FootStepGenerator::calcRoStep(const diana_online_walking_module_msgs::StepData& ref_step_data, int direction)
{
  diana_online_walking_module_msgs::StepData stp_data[num_of_step_];
  stp_data[0] = ref_step_data;
  if(ref_step_data.time_data.walking_state == diana_online_walking_module_msgs::StepTimeData::IN_WALKING)
...
void FootStepGenerator::calcStopStep(const diana_online_walking_module_msgs::StepData& ref_step_data, int direction)
{
  diana_online_walking_module_msgs::StepData stp_data;
  stp_data = ref_step_data;
  stp_data.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_ENDING;
...
void FootStepGenerator::calcRightKickStep(diana_online_walking_module_msgs::AddStepDataArray::Request::_step_data_array_type* step_data_array,
    const diana_online_walking_module_msgs::StepData& ref_step_data)
{
  diana_online_walking_module_msgs::StepData step_data_msg;
  //meter
  ...
  //Start 1 Step Data
  step_data_msg.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_STARTING;
  step_data_msg.time_data.abs_step_time += kick_time*1.8;
  step_data_msg.time_data.dsp_ratio = 1.0;

  step_data_msg.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::STANDING;
  ...
  step_data_msg.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING;
  step_data_msg.time_data.abs_step_time += kick_time*1.0;
  step_data_msg.time_data.dsp_ratio = 0.0;

  step_data_msg.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::RIGHT_FOOT_SWING;
  ...
  //StepData 5 End
  step_data_msg.time_data.walking_state = diana_online_walking_module_msgs::StepTimeData::IN_WALKING_ENDING;
  step_data_msg.time_data.abs_step_time += kick_time*1.8;
  step_data_msg.time_data.dsp_ratio = 0.0;
...
void FootStepGenerator::calcLeftKickStep(diana_online_walking_module_msgs::AddStepDataArray::Request::_step_data_array_type* step_data_array,
    const diana_online_walking_module_msgs::StepData& ref_step_data)
{
  diana_online_walking_module_msgs::StepData step_data_msg;
  //meter
  ...
  step_data_msg.position_data.moving_foot = diana_online_walking_module_msgs::StepPositionData::LEFT_FOOT_SWING;
